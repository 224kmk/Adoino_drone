...
const int SAMPLE_COUNT = 7600;
const int INPUT_NODES = 12;
const int OUTPUT_NODES = 3;

int8_t input[SAMPLE_COUNT][INPUT_NODES] = {0,};
double target[SAMPLE_COUNT][OUTPUT_NODES] = {0,};
...
void drone_loop() {
  ...
  int16_t AcXH = Wire.read(); // 입력데이터 시작 
  ...
  int16_t GyZL = Wire.read();  // 입력데이터 끝 
